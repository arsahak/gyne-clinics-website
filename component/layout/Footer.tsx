        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="space-y-6">
            ...
            <p className="text-slate-400 text-sm leading-relaxed max-w-xs">
              ...
              Gynaecology, Urogynaecology, Menopause and Aesthetic solutions in
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-slate-400">
              ...
              <FooterLink href="https://whpstore.org/en-gb">
                WHP Store
              </FooterLink>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-slate-300">
              ...
              <FooterLink href="https://www.cosrh.org/">
          ...
          <div className="space-y-6">
            <div>
              ...
              <div className="space-y-4 text-sm text-slate-400">
                ...
                <div className="flex items-center gap-3 group">
                  <div className="p-2 rounded-full bg-slate-800 text-teal-400 group-hover:bg-teal-500 group-hover:text-white transition-colors">
                    <Phone size={16} />
                  </div>
                  <a

      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <ScrollMotion animation="fadeInDown" duration={0.5}>
          <div className="text-center mb-12 md:mb-16">
            ...
            <p className="text-gray-600 text-lg md:text-xl leading-relaxed max-w-3xl mx-auto">
              Welcome to <strong className="text-primary">GyneClinics</strong>,
              where consultant-led gynaecological care meets clinical
              excellence. Our GMC-registered specialists provide comprehensive
              assessment and treatment for the full spectrum of women's health
              conditions.
            </p>
          </div>
        </ScrollMotion>
        ...
        <ScrollMotion animation="fadeInUp" delay={0.2}>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 mb-16 max-w-4xl mx-auto">
            {trustBadges.map((badge, idx) => (
              ...
              >
                <div
                  className={`w-10 h-10 md:w-12 md:h-12 mx-auto mb-3 rounded-full bg-gray-50 flex items-center justify-center ${badge.color} group-hover:scale-110 transition-transform`}
                >
                  <badge.icon size={20} />
                </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 mb-16">
          {features.map((feature, index) => (
            ...
            >
              <div
                className={`relative bg-white rounded-2xl p-8 border border-gray-100 shadow-lg hover:shadow-2xl transition-all duration-300 group hover:-translate-y-2 overflow-hidden`}
              >
                {/* Gradient Background */}
                <div
                  className={`absolute top-0 right-0 w-32 h-32 bg-gradient-to-br ${feature.gradient} blur-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-500`}
                ></div>

                <div
                  className={`relative w-14 h-14 ${feature.iconBg} ${feature.iconColor} rounded-xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300`}
                >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
              ...
              <div className="order-1 lg:order-2">
                ...
                <p className="text-gray-600 text-base md:text-lg leading-relaxed mb-6">
                  Our CQC-registered facilities combine cutting-edge diagnostic
                  technology with patient-centered care. From routine screening
                  to complex gynaecological disorders, we deliver comprehensive
                  assessment and treatment pathways guided by the latest
                  clinical evidence.
                </p>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-700 leading-relaxed">
                        Access expert clinical guidance through our secure
                        portal. Submit your health inquiry and receive a
                        consultant response within 72 hours to help you make
                        informed decisions about your care pathway.
                      </p>
                    </div>
                  </div>
                </div>

    ...
    <section className="py-24 bg-[#F8F9FA]">
      <div className="container mx-auto px-4">
        ...
        <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-6 border-b border-gray-200 pb-8">
          ...
          <Link
            href="/store"
            className="group flex items-center gap-3 px-6 py-3 bg-white border border-gray-200 rounded-full text-primary font-bold hover:border-secondary hover:text-secondary transition-all shadow-sm"
          >
    ...
    >
      ...
      <div className="p-6 flex flex-col flex-grow bg-white relative z-30">
        ...
        <div className="mt-auto pt-4 border-t border-gray-100 flex items-center justify-between">
          ...
          <span className="text-xs font-bold text-gray-400 uppercase tracking-wider group-hover:text-secondary transition-colors cursor-pointer">
            View Details
          </span>
        </div>
      </div>

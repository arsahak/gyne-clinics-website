...
const categoryConfig = {
  incontinence: {
    icon: Umbrella,
    title: "Incontinence (Bladder Leakage)",
    description: "Solutions for accidental leakage and loss of bladder control.",
  },
  prolapse: {
    icon: Activity,
    title: "Prolapse Problems",
    description:
      "Repairing weakened support for the uterus and vaginal walls.",
  },
  diagnostics: {
    icon: Microscope,
...
const ServicesCard = () => {
  const incontinenceServices = getServicesByCategory("incontinence");
  const prolapseServices = getServicesByCategory("prolapse");
  const diagnosticsServices = getServicesByCategory("diagnostics");

  const categories = [
    { key: "incontinence" as const, services: incontinenceServices },
    { key: "prolapse" as const, services: prolapseServices },
    { key: "diagnostics" as const, services: diagnosticsServices },
  ];
  ...
  return (
    <>
      ...
      <CommonHero
        title="Our Services"
        subtitle="Comprehensive urogynaecology care tailored to your needs"
        breadcrumbs={[{ label: "Services", href: "/service" }]}
        images={[
      ...
      <section className="py-16 md:py-24 bg-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 md:gap-8">
            {categories.map(({ key, services }, index) => {
